...
import icon from '../../assets/img/avocado_circle.svg';
...
const url = 'https://avocadonetwork.net';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Avocado Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Avocado-Network/avocado-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
