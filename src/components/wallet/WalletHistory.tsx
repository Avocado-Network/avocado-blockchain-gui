...
import { Card, CopyToClipboard, Flex, Table } from '@avocado/core';
import type { Row } from '../core/components/Table/Table';
import {
  slice_to_avocado_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? slice_to_colouredcoin_string(row.amount)
        : slice_to_avocado_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => slice_to_avocado_string(row.fee_amount),
